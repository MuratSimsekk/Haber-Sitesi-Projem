        ...
        <div class="card card-primary">
          ...
          <form role="form" id="form" enctype="multipart/form-data" method="post">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary" name="sayfaekle">Ekle</button>
            </div>
          </form>
        </div>
    </div><!-- /.container-fluid -->
   ...
   // Sonuçları Alalım.
    while($sonuc = $sql->fetch_assoc()){
      echo '<tr>';
        ...
        echo '<a href="sorguSilSayfa.php?ID='.$sonuc['ID'].'" class="btn btn-danger"><i class="fa fa-minus-circle" aria-hidden="true"></i></a>' ;
        echo '</td>';
